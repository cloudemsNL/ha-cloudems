...
class NILMDatabase:
    ...
    def classify(self, delta_power: float, rise_time: float = 2.0, language: str = "en",
                 rise_time_reliable: bool = False) -> list:
        ...
        NICHE_CONFIDENCE_CAP: dict = {
            "power_tool":  0.55,  # cirkelzaag, tafelzaag, lasser — zelden thuis
            "medical":     0.50,  # CPAP, zuurstofconcentrator — niche
            "garden":      0.65,  # grasmaaier, heggeschaar — buiten, seizoensgebonden
        }
