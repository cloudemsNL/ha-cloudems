...
def calculate_flex_score(
    *,
    ...
    boiler_groups_status: list[dict] = None,       # cascade groepen
    boiler_weekly_budget: dict       = None,       # weekbudget boiler (niet gebruikt in score)
    boiler_p1_active: bool           = False,      # P1 surplus actief (niet gebruikt in score)
    # NILM apparaten
