...
class ConsumptionCategoryTracker:
    ...
    def tick(
        ...
        # Trek alleen het laden (positief) af — ontladen verlaagt grid_import al vanzelf.
        charge_w = max(0.0, battery_w)   # positief = laden
        real_consumption_w = max(0.0, grid_import_w - charge_w)
