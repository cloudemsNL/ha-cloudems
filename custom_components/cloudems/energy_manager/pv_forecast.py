...
class PVForecast:
    ...
    async def _learn_orientation(
        ...
        try:
            ...
            # Require ≥4 distinct hours before trusting best_hour; with 1–2 hours
            # any outlier dominates the result.
            n_hours      = len(hf)
            ...
            if n_hours >= 4:
                ...
                # Too little data — keep previous value or default to geographic south
