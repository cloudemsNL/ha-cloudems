# -*- coding: utf-8 -*-
"""
CloudEMS Battery EPEX Scheduler — v1.21.0
...
v1.21: Saldering-bewuste spreaddcheck
  - Arbitrage (laad goedkoop → verkoop duur aan net) wordt getoetst aan de
    netto spread na salderingskorting en cycluskosten.
  - 2026: 36% saldering → pure export arbitrage is bij kleine spreads verliesgevend.
  - 2027: 0% saldering → export levert niets; eigenverbruik blijft altijd waardevol.
  - Ontlaaduren worden alleen geskipt als de prijs onder min_discharge_price valt
    én het verwachte huisverbruik laag is (export domineert).
  - Eigenverbruik (batterij dekt directe huislast) wordt nooit geblokkeerd.
  - SalderingContext uit saldering_context.py verzorgt alle berekeningen.
        ...
        for slot in disch_from_window + disch_extra:
            ...
            if sell_p < min_p:
                ...
                _LOGGER.info(
                    ...
                    "niet rendabel bij %d%% saldering (min €%.4f/kWh nodig, jaar %d)",
                    slot["hour"], sell_p,
